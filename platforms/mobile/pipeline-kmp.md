...
Launch BOTH targets yourself via the `dev:launch` skill (`/dev:launch android emulator`, `/dev:launch ios sim`) and execute the checklist on each, using each platform's own mechanics:
