...
`~/.claude/.dev-root/shared/pipeline/00-principles.md` (Guiding Principles) and the budget in
`~/.claude/.dev-root/shared/pipeline/18-output-and-universal-rules.md` (Universal Rules) before
