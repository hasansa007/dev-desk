...
3. Present to the developer **inside Phase 5's decision pack, not as a second stop**: one-paragraph
   summary per approach, a trade-offs comparison, **your recommendation with reasoning**, and the
   slice plan the winner implies — then let them pick. Stop on Ambiguity applies: when the
