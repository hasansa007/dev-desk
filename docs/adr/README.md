...
| [0015](0015-files-live-with-the-flow-that-reads-them.md) | Files live with the flow that reads them; only what nearly every door reads stays shared | Accepted |
